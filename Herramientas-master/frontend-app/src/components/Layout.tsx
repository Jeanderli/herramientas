      ...
      <div className="flex">
        ...
        <aside className="fixed left-0 top-0 h-full w-[260px] z-40 bg-surface-container-lowest border-r border-outline-variant flex flex-col pt-[64px]">
          ...
          <nav className="flex-1 space-y-1 px-2 font-code-snippet text-code-snippet">
            <Link to="/admin" className="bg-secondary-container text-on-secondary-container border-l-4 border-secondary-fixed-dim px-4 py-2 flex items-center gap-3 hover:translate-x-1 transition-transform duration-150">
              <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>dashboard</span>
              Dashboard
            </Link>
            <Link to="/admin/productos" className="text-on-surface-variant px-4 py-2 flex items-center gap-3 hover:bg-secondary/20 hover:text-secondary-fixed transition-all duration-100 hover:translate-x-1 transition-transform duration-150">
              <span className="material-symbols-outlined">inventory_2</span>
              Products
            </Link>
            <Link to="/admin/categorias" className="text-on-surface-variant px-4 py-2 flex items-center gap-3 hover:bg-secondary/20 hover:text-secondary-fixed transition-all duration-100 hover:translate-x-1 transition-transform duration-150">
              <span className="material-symbols-outlined">category</span>
              Categories
            </Link>
            <Link to="/admin/clientes" className="text-on-surface-variant px-4 py-2 flex items-center gap-3 hover:bg-secondary/20 hover:text-secondary-fixed transition-all duration-100 hover:translate-x-1 transition-transform duration-150">
              <span className="material-symbols-outlined">groups</span>
              Clients
            </Link>
            <Link to="/admin/ventas" className="text-on-surface-variant px-4 py-2 flex items-center gap-3 hover:bg-secondary/20 hover:text-secondary-fixed transition-all duration-100 hover:translate-x-1 transition-transform duration-150">
              <span className="material-symbols-outlined">payments</span>
              Sales
            </Link>
            <Link to="/admin/reportes" className="text-on-surface-variant px-4 py-2 flex items-center gap-3 hover:bg-secondary/20 hover:text-secondary-fixed transition-all duration-100 hover:translate-x-1 transition-transform duration-150">
              <span className="material-symbols-outlined">analytics</span>
              Reports
            </Link>
            <Link to="/admin/configuracion" className="text-on-surface-variant px-4 py-2 flex items-center gap-3 hover:bg-secondary/20 hover:text-secondary-fixed transition-all duration-100 hover:translate-x-1 transition-transform duration-150">
